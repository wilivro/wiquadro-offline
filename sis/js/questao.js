...
//            tr.find('textarea').val('');
    ...
    removeLineMidia: function (element) {
      if (window.confirm("Deseja realmente excluir esta mídia?")) {
        var $divContainer = element.closest('.divMidia');
        // no back-end as midias com campo vazio são excluidas.
        $divContainer.find('.url').val('');
        $divContainer.hide();
      }
    },
